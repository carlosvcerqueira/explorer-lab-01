...
const cardNumberPattern = {
    mask: [
        ...
        {
            mask: "0000 0000 0000",
            regex: /(^5[1-5]\d{0,2}|^22[2-9]\d|^2[3-7]\d{0,2})\d{0,12}/, //inicia c 5 proximo digito entre 1 e 5 aceita digititos entre 0 e 2 digitos
            cardtype: "mastercard",
        },
        {
            mask: "0000 0000 0000",
...
cardHolder.addEventListener("input", () => {
    ...
    ccHolder.innerText = cardHolder.value.length === 0 ? "FULANO DA SILVA" : cardHolder.value // if ternário
})
